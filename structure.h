#ifndef SNAPSAT_STRUCTURE_H_
#define SNAPSAT_STRUCTURE_H_
...
// Elements
extern const struct Element touch_element;

// Button
extern const struct Sensor touchpad;
...
#define MAXIMUM_NUMBER_OF_ELEMENTS_PER_SENSOR  2
